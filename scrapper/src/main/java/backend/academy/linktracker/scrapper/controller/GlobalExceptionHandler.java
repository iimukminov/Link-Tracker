...
public class GlobalExceptionHandler {
    ...
    public ApiErrorResponse handleOtherExceptions(Exception ex) {
        ...
        return createErrorResponse(
                ex, messages.getErrors().getBadRequest(), String.valueOf(HttpStatus.BAD_REQUEST.value()));
    }
    ...
    public ApiErrorResponse handleChatNotFound(ChatNotFoundException ex) {
        ...
        return createErrorResponse(
                ex, messages.getErrors().getChatNotFound(), String.valueOf(HttpStatus.NOT_FOUND.value()));
    }
    ...
    public ApiErrorResponse handleLinkNotFound(LinkNotFoundException ex) {
        ...
        return createErrorResponse(
                ex, messages.getErrors().getLinkNotFound(), String.valueOf(HttpStatus.NOT_FOUND.value()));
    }
    ...
    public ApiErrorResponse handleLinkAlreadyTracked(LinkAlreadyTrackedException ex) {
        ...
        return createErrorResponse(
                ex, messages.getErrors().getLinkAlreadyTracked(), String.valueOf(HttpStatus.CONFLICT.value()));
    }
    ...
    public ApiErrorResponse handleChatAlreadyRegistered(ChatAlreadyRegisteredException ex) {
        ...
        return createErrorResponse(
                ex, messages.getErrors().getChatAlreadyRegistered(), String.valueOf(HttpStatus.CONFLICT.value()));
    }
    ...
    public ApiErrorResponse handleRateLimitExceeded(RateLimitExceededException ex) {
        ...
        return createErrorResponse(
                ex, messages.getErrors().getRateLimitExceeded(), String.valueOf(HttpStatus.TOO_MANY_REQUESTS.value()));
    }
