...
public class OutboxRepositoryJpaAdapter implements OutboxRepository {
    ...
    @Override
    public void save(OutboxEvent event) { jpaRepository.save(event); }

    @Override
    public List<OutboxEvent> findPending(int limit) {
        return jpaRepository.findByStatusOrderByCreatedAtAsc(OutboxEvent.OutboxStatus.PENDING, PageRequest.of(0, limit));
    }
